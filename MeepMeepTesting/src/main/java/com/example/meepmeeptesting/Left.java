    ...
    public static void main(String[] args) {
        ...
        RoadRunnerBotEntity myBot = new DefaultBotBuilder(meepMeep)
                ...
                .followTrajectorySequence(drive ->
                        drive.trajectorySequenceBuilder(new Pose2d(-31.18, -64.73, Math.toRadians(90.00)))
                                ...
                                .splineTo(new Vector2d(-20.93, -3.56), Math.toRadians(135.00))
                                .build());
        ...
        myBot = new DefaultBotBuilder(meepMeep)
                ...
                .setDimensions(14.5, 14.0)
                .followTrajectorySequence(drive ->
                        drive.trajectorySequenceBuilder(new Pose2d(-20.93, -3.56, Math.toRadians(135.00)))
        ...
        myBot = new DefaultBotBuilder(meepMeep)
                ...
                .setDimensions(14.5, 14.0)
                .followTrajectorySequence(drive ->
                        drive.trajectorySequenceBuilder(new Pose2d(-12.47, -14.25, Math.toRadians(135.00)))
