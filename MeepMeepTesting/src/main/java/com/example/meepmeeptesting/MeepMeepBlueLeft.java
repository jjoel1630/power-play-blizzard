        ...
        RoadRunnerBotEntity myBot = new DefaultBotBuilder(meepMeep)
                ...
                .followTrajectorySequence(drive ->
                        drive.trajectorySequenceBuilder(new Pose2d(-32.81, 64.87, Math.toRadians(270.00)))
                                ...
                                .splineTo(new Vector2d(-12.62, 17.52), Math.toRadians(270))
...
//        // Go to storage 1
        myBot = new DefaultBotBuilder(meepMeep)
                ...
                .setDimensions(14.5, 14.0)
                .followTrajectorySequence(drive ->
                        drive.trajectorySequenceBuilder(new Pose2d(-19.00, 4.01, Math.toRadians(225)))
...
//        // Go to storage 2
        myBot = new DefaultBotBuilder(meepMeep)
                ...
                .setDimensions(14.5, 14.0)
                .followTrajectorySequence(drive ->
                        drive.trajectorySequenceBuilder(new Pose2d(-12.17, 20.49, Math.toRadians(225)))
                                .splineTo(new Vector2d(-63.97, 11.75), Math.toRadians(180))
                                .build());
//
...
//                .setDimensions(14.5, 14.0)
//                .followTrajectorySequence(drive ->
//                        drive.trajectorySequenceBuilder(new Pose2d(-28.56, 5.21, Math.toRadians(315)))
//                                .lineToLinearHeading(new Pose2d(-43.36, 13.69, Math.toRadians(180)))
...
//                                .build());
        ...
        myBot = new DefaultBotBuilder(meepMeep)
                ...
                .setDimensions(14.5, 14.0)
                .followTrajectorySequence(drive ->
                        drive.trajectorySequenceBuilder(new Pose2d(-63.97, 11.75, Math.toRadians(180.00)))
        ...
        myBot = new DefaultBotBuilder(meepMeep)
                ...
                .setDimensions(14.5, 14.0)
                .followTrajectorySequence(drive ->
                        drive.trajectorySequenceBuilder(new Pose2d(-19.60, 4.60, Math.toRadians(225)))
        ...
        myBot = new DefaultBotBuilder(meepMeep)
                ...
                .followTrajectorySequence(drive ->
                        drive.trajectorySequenceBuilder(new Pose2d(-11.58, 15.44, Math.toRadians(270.00)))
                                .lineToLinearHeading(new Pose2d(-12.62, 35.93, Math.toRadians(0.00)))
                                .build());
