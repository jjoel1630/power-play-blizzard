...
public class SampleMecanumDrive extends MecanumDrive {
    public static PIDCoefficients TRANSLATIONAL_PID = new PIDCoefficients(4.4, 0, 0.4);
    public static PIDCoefficients HEADING_PID = new PIDCoefficients(5.95, 0, 0);

    public static double LATERAL_MULTIPLIER = 1.38533;
